...
std::vector<std::vector<int>> calendarLetters = {
    {0x20, 0x50, 0x70, 0x88, 0x88}, // A
    {0xe0, 0x90, 0xe0, 0x90, 0xe0}, // B
    {0x0, 0x0, 0x0, 0x0, 0x0}, // C
    {0xe0, 0x90, 0x90, 0x90, 0xe0}, // D
    {0xF0, 0x80, 0x80, 0x80, 0xF0}, // E
    {0xF0, 0x80, 0x80, 0x80, 0x80}, // F
    {0x70, 0x80, 0xF0, 0x90, 0x70}, // G
    {0x0, 0x0, 0x0, 0x0, 0x0}, // H
    {0x10, 0x10, 0x10, 0x10, 0x10}, // I
    {0x70, 0x10, 0x10, 0x50, 0x70}, // J
    {0x90, 0xA0, 0xC0, 0xA0, 0xC0}, // K
...
std::vector<std::vector<int>> weatherIcons = {
    ...
    {0x03, 0xc0, 0x07, 0xe0, 0x07, 0xe0, 0x07, 0xe0, 0x03, 0xc0},                                     // clear
    ...
    {0x01, 0x80, 0x01, 0x80, 0x01, 0x80, 0x01, 0x80, 0x00, 0x00, 0x01, 0x80, 0x01, 0x80}              // unknown
};
